...
const int RIGHT_CHAIN_PORT = 13; //14
...
pros::Motor left_wheel (LEFT_WHEEL_PORT,true);
pros::Motor right_wheel (RIGHT_WHEEL_PORT, true);
pros::Motor left_chain (LEFT_CHAIN_PORT,false);
pros::Motor right_chain (RIGHT_CHAIN_PORT, false);
